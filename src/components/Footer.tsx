        ...
        >
          <motion.div variants={staggerItem}>
            ...
            <p className="text-gray-400 text-sm leading-relaxed">
              Providing hygienic and quality-assured bottled drinking water for homes, offices, and businesses across Sri Lanka since 2010.
            </p>
          </motion.div>

          <motion.div variants={staggerItem}>
            <h4 className="font-semibold text-sm tracking-wider uppercase mb-5">Quick Links</h4>
          ...
          <motion.div variants={staggerItem}>
            <h4 className="font-semibold text-sm tracking-wider uppercase mb-5">Follow Us</h4>
            <p className="text-gray-400 text-sm mb-4">Stay connected on social media.</p>
            <div className="flex gap-3">
              <a
                href="https://www.facebook.com/profile.php?id=100086012830758"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-full bg-gray-800 hover:bg-brand-500 flex items-center justify-center transition-colors duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-400 focus-visible:ring-offset-2 focus-visible:ring-offset-gray-900"
                aria-label="Facebook"
              >
              ...
              <a
                href="https://www.instagram.com/coolwaterlk/"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-full bg-gray-800 hover:bg-brand-500 flex items-center justify-center transition-colors duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-400 focus-visible:ring-offset-2 focus-visible:ring-offset-gray-900"
